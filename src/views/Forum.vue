<template>
    ...
    <div class="modal-action">
        ...
        <button type="submit" class="text-white btn btn-primary bg-orange-400
            border-orange-400 hover:bg-orange-500 
            hover:border-orange-500">Simpan</button>
    </div>
    </form> 
    </div>
    </div>
    ...
    <div v-if="!isLoading && !isError" class="px-24">
        <div class="my-2 space-x-2">
            <a href="#forumModal" class="text-white btn btn-primary bg-orange-400
            border-orange-400 hover:bg-orange-500 hover:border-orange-500">Create Forum</a>
        <select 
